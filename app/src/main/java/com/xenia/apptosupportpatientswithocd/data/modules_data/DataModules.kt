...
val contentOCD = listOf(
    ...
    ModuleContent("Обсессии", "fff"),
    ModuleContent("Проявления обсессий", "fff"),
    ModuleContent("Отличительные черты обсессий", "fff"),
    ModuleContent("Профилактика", "fff")
)
