...
fun ListAllMoodsScreen(
    ...
    Scaffold(
        topBar = {
            TopBarWithArrowBack(topBarName = stringResource(R.string.list_notes)) {
                onBackPressed()
            }
        }
    ) { contentPadding ->
                    ...
                    backgroundContent = {
                        ...
                        Row(
                            ...
                            Icon(
                                ...
                                contentDescription = stringResource(R.string.delete_mood_note),
                                tint = Color.White
                            )
                        }
                    }
                ...
                LaunchedEffect(show) {
                    if (!show) {
                        ...
                        Toast.makeText(context,
                            context.getString(R.string.note_delete), Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
